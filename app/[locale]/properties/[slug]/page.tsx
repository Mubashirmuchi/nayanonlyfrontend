...
//   return (
//     <div className="bg-[#f4f1ec] py-16">
//       <div className="max-w-7xl mx-auto px-6">

//         {/* Back */}
//         <Link href="/properties" className="text-sm text-gray-500 mb-8 block">
//           ← Back to Home
//         </Link>
...
//           <div className="h-[300px] bg-gray-200 rounded-md flex items-center justify-center">
//             Map Placeholder
//           </div>
//         </div>
