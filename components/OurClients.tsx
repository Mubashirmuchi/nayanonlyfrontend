      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <h2 className="text-4xl lg:text-5xl font-semibold leading-tight mb-6">
            <span className="text-gray-900">Serving a Diverse </span>
            <span className="text-gray-500">Community of</span>
            <br />
            <span className="text-gray-900">Investors and Partners</span>
          </h2>
